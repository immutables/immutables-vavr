...
@JavaslangLinkedHashMapEncodingEnabled
...
@JavaslangSetEncodingEnabled
@JavaslangSortedMapEncodingEnabled
@JavaslangSortedSetEncodingEnabled
@JavaslangStackEncodingEnabled
@JavaslangTreeMapEncodingEnabled
@JavaslangTreeSetEncodingEnabled
@JavaslangVectorEncodingEnabled
public @interface JavaslangEncodingEnabled
{
  // No extra methods
}
