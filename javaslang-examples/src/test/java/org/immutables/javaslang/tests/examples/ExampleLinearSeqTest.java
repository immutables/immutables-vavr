...
import org.immutables.javaslang.examples.ImmutableExampleLinearSeqType;
import org.junit.Assert;
import org.junit.Test;

public final class ExampleLinearSeqTest
{
  @Test
  public void testAdd()
  {
    final ImmutableExampleLinearSeqType.Builder b =
      ImmutableExampleLinearSeqType.builder();

    b.addIntegers(Integer.valueOf(0));
    b.addIntegers(Integer.valueOf(1));
    b.addIntegers(Integer.valueOf(2));

    final ImmutableExampleLinearSeqType a0 = b.build();
