...
public final class ExampleMultimapMapTest
{
  ...
  public void testAdd()
  {
    ...
    Assert.assertEquals(HashSet.of(Integer.valueOf(0)), a0.integers().get("A").get());
    Assert.assertEquals(HashSet.of(Integer.valueOf(1)), a0.integers().get("B").get());
    Assert.assertEquals(HashSet.of(Integer.valueOf(2)), a0.integers().get("C").get());
  }
  ...
  public void testSetEntries()
  {
    ...
    Assert.assertEquals(HashSet.of(Integer.valueOf(0)), a1.integers().get("A").get());
    Assert.assertEquals(HashSet.of(Integer.valueOf(1)), a1.integers().get("B").get());
    Assert.assertEquals(HashSet.of(Integer.valueOf(2)), a1.integers().get("C").get());
  }
}
