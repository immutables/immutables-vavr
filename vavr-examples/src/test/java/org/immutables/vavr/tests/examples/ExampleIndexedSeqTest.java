...
import org.immutables.vavr.examples.ImmutableExampleIndexedSeqType;
...
public final class ExampleIndexedSeqTest
{
  ...
  public void testAdd()
  {
    final ImmutableExampleIndexedSeqType.Builder b =
      ImmutableExampleIndexedSeqType.builder();

    b.addIntegers(Integer.valueOf(0));
    b.addIntegers(Integer.valueOf(1));
    b.addIntegers(Integer.valueOf(2));

    final ImmutableExampleIndexedSeqType a0 = b.build();
  ...
  public void testAddVarArgs()
  {
    ...
    final ImmutableExampleIndexedSeqType a0 = b.build();
    Assert.assertEquals(4, a0.integers().size());
    Assert.assertEquals(0L, a0.integers().get(0).longValue());
    Assert.assertEquals(1L, a0.integers().get(1).longValue());
